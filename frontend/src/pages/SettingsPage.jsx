...
function SettingsPage() {
  ...
  return <>
    <main className="settings-main settings-page"><header className="settings-heading"><p>Manage your enterprise environment, security policies, and automation triggers.</p></header>
